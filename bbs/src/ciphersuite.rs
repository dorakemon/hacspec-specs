...
pub type BBSSecretKey = Scalar;
pub type BBSPublicKey = G2;
pub type BBSSignature = (G1, Scalar);
...
pub fn base_g2() -> G2 {
    ((Fp::from_hex("024aa2b2f08f0a91260805272dc51051c6e47ad4fa403b02b4510b647ae3d1770bac0326a805bbefd48056c8c121bdb8"),
